...
/**
 * Created by maziar on 28/11/2016.
 */
...
function Selections(){
    ...
    Selections.prototype.updateRgbColorGauge=function(divGaugeColorId,r,y,b){
        ...
        rybArray.sort(function (a,b) {return a-b });
    ...
    Selections.prototype.updateOgpColorGauge=function(divGaugeColorId,C,M,Y){
        ...
        /*
         ...
         x1+y2+z3= C + M + Y
         x1c+y2c+z3c + x1m+y2m+z3m + x1y+y2y+z3y = C + M + Y

         added fleibility:  arbitrary c , m , y
         ...
         y3=0;
         + y*0.43 + z*0.2 =C-c
         x*0.43 + y*0.23 + z*0.8 =M-m
         x*0.57 + y*0.43 +       =Y-y

         y*0.43 =Y- x*0.57  => y=(Y -x*0.57)/0.43

         z*0.2 = C -y*0.43  => z= (C- y*0.43)/0.2 => z =(C -(Y -x*0.57)*0.43/0.43)/0.2 => z=(C - Y +x*0.57) /0.2

         x*0.43 + (Y -x*0.57)*0.23/0.43 + (C - Y +x*0.57)*0.8/0.2 = M

         x*( 0.43-0.57*0.23/0.43 +0.57*0.8/0.2) = M - Y*0.23/0.43 - C* 0.8 /0.2;


         result:

         x= ( M - Y*0.23/0.43 - C* 0.8 /0.2) / ( 0.43-0.57*0.23/0.43 +0.57*0.8/0.2) ;
         y=(Y -x*0.57)/0.43 ;
         z=(C - Y +x*0.57) /0.2;
...
function copyMiddleFrameColorDivsFromRight(ndivs){
    for(j=1;j<=7;j++) {
        for (var i = 0; i < ndivs; i++) {
            ...
            /*if((j==1) && (i==0))
             {
             console.log(divFullId);
             console.log(colorDivs.divs[divFullId]);
...
function polarRect(destinationDivId,r,teta,rgb,i,centerX,centerY){
    ...
    $('#mixing-palette-m'+i).css({
        position: "absolute",
        marginTop: centerY+r*Math.sin(teta*Math.PI/180.0), marginLeft: centerX+r*Math.cos(teta*Math.PI/180.0),
        width:40,
        height:40
    });
